...
Shiny application that functions as the user interface of a LIMS system for the Calfee/Matthay Lab at UCSF. Modules are designed to make sample storage, tracking, and management simple. Data is stored using REDCap and accessed via API. Automated tests are implimented to ensure updates do not produce unintended consequences.

...
Shiny application that functions as the user interface of a LIMS system. Modules are designed to make sample storage, tracking, and management simple and introduce as little human error as possible. Data is stored within REDCap and accessed via API. Automated tests are implimented to ensure updates do not produce unintended consequences.
